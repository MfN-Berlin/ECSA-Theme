...
print  theme('flexslider', array('items' => $newItems, 'settings' => $settings)) ;

?>
<div class="events">
	<a href="<?php //echo $_SERVER['REQUEST_URI']; ?><?php global $base_url; print $base_url;?>/<?php global $language_url; print $language_url->language;?>/museum/events"><h2 class="pane-title"><?php print t('Events today');?> <i class="calendar outline icon"><span class="calendar-date"><?php print date('j');?></span></i></h2></a>
